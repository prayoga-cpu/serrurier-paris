...
export const NORME_A2P: Guide = {
  slug: "norme-a2p-expliquee",
  updated: "2026-08-12",
  related: ["serrurerie-assurance-habitation", "prix-serrurier-paris"],
  content: {
    fr: {
      title: "La norme A2P expliquée simplement",
      keyword: "norme a2p serrure",
      summary:
      ...
      sections: [
        ...
        {
          heading: "Une, deux ou trois étoiles : ce que ça change",
          paragraphs: [
            "Pour les serrures et les cylindres, l'échelle est directement lisible en minutes de résistance.",
          ],
          list: [
            "A2P une étoile : cinq minutes de résistance. Convient à un appartement en étage, dans un immeuble avec contrôle d'accès, sur une porte saine.",
            "A2P deux étoiles : dix minutes. Le bon niveau pour un rez-de-chaussée, un premier étage accessible, ou un logement au calme et souvent inoccupé.",
            "A2P trois étoiles : quinze minutes. Réservé aux situations réellement exposées, ou exigé par certains contrats d'assurance sur des biens de valeur.",
            "Pour les blocs-portes blindés, la même logique s'applique sous les appellations A2P BP1, BP2 et BP3 — cinq, dix et quinze minutes.",
          ],
        },
        {
      ...
      faq: [
        {
          question: "Une serrure A2P est-elle obligatoire ?",
          answer:
            "Aucune loi ne l'impose pour un logement. En revanche, certains contrats d'assurance habitation la conditionnent : la clause « moyens de protection » peut exiger un nombre de points de fermeture et une certification donnée, en particulier pour les rez-de-chaussée ou au-delà d'un certain capital mobilier assuré.",
        },
        {
          question: "Combien coûte une serrure certifiée A2P ?",
          answer:
            "Le surcoût par rapport à un modèle standard porte surtout sur le matériel, pas sur la pose. Un cylindre A2P une étoile à clé protégée reste dans un ordre de grandeur raisonnable ; l'écart se creuse avec le nombre d'étoiles et sur les serrures multipoints certifiées. Le devis doit détailler la référence exacte pour que la comparaison ait un sens.",
        },
        {
          question:
            "Puis-je poser une serrure A2P sur une porte d'appartement en copropriété ?",
          answer:
            "Oui pour tout ce qui n'altère pas l'aspect extérieur : cylindre, gâche, renforts internes relèvent de votre partie privative. Remplacer la porte ou modifier sa face côté palier suppose en revanche l'accord de la copropriété, et parfois une autorisation supplémentaire en secteur protégé.",
        },
        {
          question: "A2P et clé protégée, est-ce la même chose ?",
          answer:
            "Non. A2P mesure la résistance à l'effraction ; la clé protégée empêche la reproduction non autorisée du double. Les deux se complètent : la première vous protège de la force, la seconde des clés qui circulent. Un cylindre peut avoir l'une, l'autre, ou les deux.",
        },
      ],
    },
    en: {
      title: "The A2P standard, explained simply",
      keyword: "a2p lock standard",
      summary:
      ...
      sections: [
        ...
        {
          heading: "One, two or three stars: what changes",
          paragraphs: [
            "For locks and cylinders the scale reads directly in minutes of resistance.",
          ],
          list: [
            "A2P one star: five minutes. Suits an upper-floor flat in a building with access control, on a sound door.",
            "A2P two stars: ten minutes. The right level for a ground floor, an accessible first floor, or a home left empty often.",
            "A2P three stars: fifteen minutes. For genuinely exposed situations, or where an insurance policy requires it for valuable contents.",
            "For armoured door sets the same logic applies under the labels A2P BP1, BP2 and BP3 — five, ten and fifteen minutes.",
          ],
        },
        {
      ...
      faq: [
        {
          question: "Is an A2P lock compulsory?",
          answer:
            'No French law requires one for a home. Some home insurance policies do condition cover on it, though: the "protection measures" clause can require a number of locking points and a given certification, particularly for ground-floor flats or above a certain insured contents value.',
        },
        {
          question: "What does a certified A2P lock cost?",
          answer:
            "The premium over a standard model is mostly in the hardware, not the fitting. A one-star protected-key cylinder stays within a reasonable range; the gap widens with star count and on certified multi-point locks. The quote should state the exact reference so the comparison means something.",
        },
        {
          question:
            "Can I fit an A2P lock to a flat door in a shared building?",
          answer:
            "Yes for anything that doesn't alter the external appearance: cylinder, strike plate and internal reinforcements are your private property. Replacing the door or changing its landing-side face needs the building's approval, and sometimes an extra consent in a conservation area.",
        },
        {
          question: "Are A2P and protected keys the same thing?",
          answer:
            "No. A2P measures resistance to forced entry; a protected key prevents unauthorised copying. They complement each other: the first protects you against force, the second against keys in circulation. A cylinder can have either, or both.",
        },
      ],
    },
  },
