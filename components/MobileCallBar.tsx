...
export default function MobileCallBar() {
  return (
    <a
      ...
      className="fixed inset-x-0 bottom-0 z-50 flex items-center justify-center gap-2 border-t border-ink/10 bg-ink px-4 py-3.5 text-base font-semibold text-paper lg:hidden"
    >
      <svg
        width="18"
        height="18"
